# Headless CLI Pipeline Guide

This guide demonstrates how to use Claude Docker in headless CLI pipelines, including Argo Workflows, Kubernetes Jobs, and CI/CD systems.

## Table of Contents

- [Real-time Log Analysis](#real-time-log-analysis)
