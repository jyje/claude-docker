...
DevOps 워크플로우에서 Claude Code 도커 이미지를 사용하려면 ghcr.io에서 이미지를 가져오세요:
...
Claude Code가 `ANTHROPIC_API_KEY` 환경변수를 사용하도록 설정 파일을 생성합니다:
